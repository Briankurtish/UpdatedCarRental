...
private void DisplayCars()
{
    ...
    private void EditBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditBtnActionPerformed
        ...
        try{
            ...
            String Query = "update cartbl set car_brand='"+brandTb.getText()+"',car_model='"+ModelTb.getText()+"',status='"+StatusCb.getSelectedItem().toString()+"', price="+PriceTb.getText()+" where RegNum='"+Reg+"'";
